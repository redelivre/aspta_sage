...
/**
 * Program Paraiba Library widget
 *
 * @package WordPress
 * @subpackage AS-PTA
 * @since AS-PTA 0.2
...
class ProgramParaibaLibraryWidget extends WP_Widget {
  /**
   * Sets up the widgets name etc
   */
  public function __construct() {
    $widget_ops = array( 
      'classname' => 'program_paraiba_library_widget',
      'description' => __('Biblioteca do Programa Paraiba'),
    );
    parent::__construct( 'program_paraiba_library_widget', __('Biblioteca do Programa Paraiba'), $widget_ops );
  }
  /**
