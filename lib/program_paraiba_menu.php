...
class ProgramParaibaMenuWidget extends WP_Widget {
  /**
   * Sets up the widgets name etc
   */
  public function __construct() {
    $widget_ops = array( 
      'classname' => 'program_paraiba_menu_widget',
      'description' => __('Menu do Programa Paraiba'),
    );
    parent::__construct( 'program_paraiba_menu_widget', __('Menu do Programa Paraiba'), $widget_ops );
  }
  /**
