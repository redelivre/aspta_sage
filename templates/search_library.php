...
<div id="biblioteca">
    <div class="container col-md-8 col-sm-offset-1">
      <div class="row">
        <div class="titulo">
	          ...
	          <div class="input-group">
	            <span class="input-group-addon">
	              ...
	              <a href="<?php echo get_term_link($term) ?>">
                        <label for="material[]"><?php echo $term->name ?></label>
                      </a>
	            </span>
	          </div>
	        <?php 
	            ...
	            <div class="input-group">
	              <span class="input-group-addon">
	                <input type='checkbox' name="theme[]" 
                        ...
                        />
	                <a href="<?php echo get_term_link($term) ?>">
                          <label for="theme[]"><?php echo $term->name ?></label>
                        </a>
	              </span>
	            </div>
                  <?php 
	  ...
	  <div class="opcoes">
	    <div class="input-group">
	      ...
	      <input type="text" class="form-control" name="article_title" 
                value="<?php echo isset($_GET['article_title'])?$_GET['article_title']:"" ?>" 
              />  	
            </div>						  
	    <div class="input-group">
	      <span class="input-group-addon">
	      ...
	      <select class="form-control" name ="_author">
	        <option value="">Nenhum autor selecionado</option>
	            ...
	            <option value="<?php echo $_author->ID ?>" 
                    ...
                    >
                      <?php echo $_author->user_nicename ?>
                    </option>
	        <?php 
                  } 
                ?>
	      ...
	      <select class="form-control" name ="edition">
	        ...
	        <?php 
	            ...
	            if (!empty($keyword)){
	        ?>
	              <option value="<?php echo $keyword[0]; ?>" 
                        <?php is_selected($keyword[0],$_GET, "edition"); ?>
                      >
                        <?php echo $keyword[0]; ?>
                      </option>
	        <?php 
	      ...
	      <span class="input-group-addon">
              ...
              </span><!-- this is cool -> https://codex.wordpress.org/Function_Reference/get_year_link -->
	      <?php 
                $_years = range(date("Y"), 2011);  
              ?>
	      <select class="form-control" name="_year">
	        ...
	        <?php 
                ...
                ?>
	            <option value="<?php echo $_year; ?>" <?php is_selected($_year,$_GET, "_year"); ?>>
                      <?php echo $_year; ?>
                    </option>
	        <?php 
                  } 
    ...
    <div class="row">
      <div class="col-md-4 biblioteca-sidebar"></div>
      <div class="clearfix"></div>
    </div>
  </div>
</div>
