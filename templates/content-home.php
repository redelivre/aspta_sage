								...
								<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									<div class="media slide cf">
										...
										<div class="entry-image">
											...
											if(is_array($thumb))
											{?>
											<div class="highlights-image" style="background-image: url('<?php echo $thumb[0]; ?>')" ></div>
											<?php } ?>
										</div>
										<?php endif; ?>
										<div class="bd">
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<div class="media home-news">
									...
									<div class="entry-image ">
										...
										$thumb = wp_get_attachment_image_src($post_thumbnail_id, 'slider', false);
										if(is_array($thumb)) { ?>
										<div class="highlights-image" style="background-image: url('<?php echo $thumb[0]; ?>')" >
										</div>
										<?php } ?>
									</div>
									<?php endif; ?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-sm-10 blog-pratos-limpos">
					...
					<p><strong><h4 class="<?php if( ++$i === $numItems ) echo "sem-borda"; ?>" ><a href='<?php echo esc_url( $item->get_permalink() ); ?>' title='<?php echo esc_html( $item->get_title() ); ?>'><?php echo esc_html( $item->get_title()); ?></a></h4></strong></p>
					<?php endforeach; ?>
