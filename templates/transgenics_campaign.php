  ...
  <div class="tema-card">
    <a href="<?php get_site_url(); ?>/itens-de-campanha/boletim/">
      <div id="tema-box-01" class="tema-box-laranja">
        ...
        <div class="tema-icone"><img class="image-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/boletim.png"></div>
  ...
  <div class="tema-card">
    <a href="<?php get_site_url(); ?>/itens-de-campanha/gm-free-brazil/">
      <div class="tema-box-verde">
       ...
       <div class="tema-icone"><img class="image-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gm-free-brasil.png"></div>
  ...
  <div class="tema-card">
    <a href="<?php get_site_url(); ?>/itens-de-campanha/materiais-de-campanha/">
      <div class="tema-box-laranja">
        ...
        <div class="tema-icone"><img class="image-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/materiais-de-campanha.png"></div>
  ...
  <div class="tema-card">
    <a href="<?php get_site_url(); ?>/itens-de-campanha/monitoramento-ctnbio/">
      <div class="tema-box-verde">
        ...
        <div class="tema-icone"><img class="image-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/monitoramento-da-ctnbio.png"></div>
