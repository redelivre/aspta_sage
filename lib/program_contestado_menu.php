...
/**
 * Program Constestado Menu widget
 *
 * @package WordPress
 * @subpackage AS-PTA
 * @since AS-PTA 0.2
...
class ProgramConstestadoMenuWidget extends WP_Widget {
  /**
   * Sets up the widgets name etc
   */
  public function __construct() {
    $widget_ops = array( 
      'classname' => 'program_contestado_menu_widget',
      'description' => __('Menu para o Programa Constestado'),
    );
    parent::__construct( 'program_contestado_menu_widget', __('Menu para o Programa Constestato'), $widget_ops );
  }
  /**
