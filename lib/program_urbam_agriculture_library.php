...
/**
 * Program Urbam Agriculture Library widget
 *
 * @package WordPress
 * @subpackage AS-PTA
 * @since AS-PTA 0.2
...
class ProgramUrbamAgricultureLibraryWidget extends WP_Widget {
  /**
   * Sets up the widgets name etc
   */
  public function __construct() {
    $widget_ops = array( 
      'classname' => 'program_urbam_agriculture_library_widget',
      'description' => __('Biblioteca do Programa Agricultura Urbana'),
    );
    parent::__construct( 'program_urbam_agriculture_library_widget', __('Biblioteca do Programa Agricultura Urbana'), $widget_ops );
  }
  /**
