...
$asptadivi_includes = [
		...
		'functions-revista.php',
		'functions-campanha.php'
		/*
...
foreach ($asptadivi_includes as $file) {
...
class AsptaDivi {
	...
	public function init() {
		...
		$this->create_newspaper_pdf();
		
		add_filter('post_type_labels_article', array($this, 'replace_menu_labels') );
		add_filter('taxonomy_labels_issuem_issue', array($this, 'replace_issuem_issue_menu_labels') );
		add_filter('taxonomy_labels_issuem_issue_categories', array($this, 'replace_issuem_issue_categories_menu_labels') );
		add_filter('taxonomy_labels_issuem_issue_tags', array($this, 'replace_issuem_issue_tags_menu_labels') );
	...
	**/
	...
	function replace_menu_labels($labels) {
	    $labels->name = 'Artigos';
	...
	function replace_issuem_issue_menu_labels($labels) {
	...
	function replace_issuem_issue_categories_menu_labels($labels) {
	...
	function replace_issuem_issue_tags_menu_labels($labels) {
	...
	public static function get_post_thumbnail($echo = true, $magazine = false) {
